  ...
  return (
    <div className={`${milker.variable} ${sf.variable} ${caveat.variable} bg-white overflow-x-hidden`}>
      <nav data-no-trail className="fixed top-0 right-0 p-5 flex items-center gap-2 z-40">
        ...
        <LinkPreview
          url="https://linkedin.com/in/matthew-min-kim"
          className="flex items-center justify-center w-9 h-9 rounded-full bg-gray-900 text-white hover:bg-[#0A66C2] transition-colors"
          width={200}
          height={130}
          isStatic
        ...
        <LinkPreview
          url="https://github.com/MatthewKim07"
          className="flex items-center justify-center w-9 h-9 rounded-full bg-gray-900 text-white hover:bg-[#6e40c9] transition-colors"
          width={200}
          height={130}
        >
          <svg width={15} height={15} viewBox="0 0 24 24" fill="currentColor">
